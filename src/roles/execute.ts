...
export const executePhase: RoleConfig = {
  freshScope(_paths, _workId, _repoId, _runId): Promise<RoleFreshScope> {
    throw new DevtaskError("execute phase uses launchExecuteTask, not freshScope");
  },

  resumeScope(_paths, _workId, _repoId, _runId): RoleScope {
  ...
  async finalize(_paths, workId, repoId, sessionRecord): Promise<RoleResult> {
