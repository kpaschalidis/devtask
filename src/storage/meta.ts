...
export function parseTaskMeta(value: unknown): TaskMeta {
  ...
  return {
    ...
    agentThreadId: value.agentThreadId === undefined || value.agentThreadId === null ? null : requireString(value, "agentThreadId"),
    agentSessionId: value.agentSessionId === undefined || value.agentSessionId === null ? null : requireString(value, "agentSessionId"),
    ...
    resultSummary: value.resultSummary === undefined || value.resultSummary === null ? null : requireString(value, "resultSummary"),
